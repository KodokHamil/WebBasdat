...
<form class="row g-3" method="get">
    ...
    <div class="col-auto">
        <input type="submit" name="cari" value="Cari admin" class="btn btn-secondary" />
    </div>
</form>
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1   = "select * from admin $sqltambahan";
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="admin.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
